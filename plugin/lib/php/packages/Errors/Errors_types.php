...
$GLOBALS['edam_error_E_EDAMErrorCode'] = array(
  'UNKNOWN' => 1,
  'BAD_DATA_FORMAT' => 2,
  'PERMISSION_DENIED' => 3,
  'INTERNAL_ERROR' => 4,
...
final class edam_error_EDAMErrorCode {
  const UNKNOWN = 1;
...
class edam_error_EDAMUserException extends TException {
  static $_TSPEC;
...
class edam_error_EDAMSystemException extends TException {
  static $_TSPEC;
...
class edam_error_EDAMNotFoundException extends TException {
  static $_TSPEC;

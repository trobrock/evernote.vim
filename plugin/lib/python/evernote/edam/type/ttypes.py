...
class Notebook(object):
  ...
  def __init__(self, guid=None, name=None, updateSequenceNum=None, defaultNotebook=None, serviceCreated=None, serviceUpdated=None, publishing=None, published=None, stack=None, sharedNotebookIds=None,):
    self.guid = guid
    self.name = name
    self.updateSequenceNum = updateSequenceNum
...
class LinkedNotebook(object):
  ...
  def __init__(self, shareName=None, username=None, shardId=None, shareKey=None, uri=None, guid=None, updateSequenceNum=None,):
